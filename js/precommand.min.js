$(function() {
  ...
  $("#precommandForm input,#precommandForm textarea").jqBootstrapValidation({
    ...
    submitSuccess: function($form, event) {
	  ...
	  date: daterdv,
	  adressFrom: inputAddressFrom,
	  CPFrom: inputCityFrom,
	  cityFrom: inputStateFrom,
	  adressTo: inputAddressTo,
	  CPto: inputCityTo,
	  cityTo: inputStateTo,
          name: name,
          phone: phone,
        ...
        success: function() {
          ...
          $('#success > .alert-success')
            .append("<strong>Votre précommande a été enregistrée, nous vous recontacterons dans les plus brefs détails. </strong>");
          $('#success > .alert-success')
            .append('</div>');
          //clear all fields
        ...
        error: function() {
          ...
          $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
            .append("</button>");
          $('#success > .alert-danger').append($("<strong>").text("Désolé " + firstName + ", Le serveur mail ne répond plus. Veuillez réessayer plus tard."));
